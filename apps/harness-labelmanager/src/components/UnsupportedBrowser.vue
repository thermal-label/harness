...
<template>
  <div class="unsupported">
    ...
    <p>
      The harness needs <strong>{{ summary }}</strong> to talk to a USB-connected labelmanager. Your
    ...
    <ul>
      ...
      <li>
        ...
        <code>pnpm --filter verify-cli verify labelmanager &lt;model&gt;</code> from a terminal. No
        browser needed.
      </li>
      <li>
