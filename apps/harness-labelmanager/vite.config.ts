...
// (`@thermal-label/transport`, `@thermal-label/labelmanager-core`) carry
...
// Same trick for `@thermal-label/d1-core` — labelmanager-core consumes
// it transitively, and Vite would otherwise pick up the copy nested
// under labelmanager's `node_modules/.pnpm/` instead of the
// sibling-checkout's built dist.
